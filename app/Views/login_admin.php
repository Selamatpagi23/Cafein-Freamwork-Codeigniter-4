...
<body>
    ...
    <form action="Admin/auth_admin" method="POST">
        ...
        <div class="inputGroup inputGroup1">
            ...
            <input type="text" id="email" class="email" name="email" maxlength="256" placeholder="Email" />
            <span class="indicator"></span>
        </div>
        <div class="inputGroup inputGroup2">
            <label for="password">Password</label>
            <input type="password" id="password" class="password" name="user_password" placeholder="Password" />
        </div>
